...
// load event : The load event is fired when the whole page has loaded, including all dependent resources 
...
// beforeunload event: The beforeunload event is fired when the window, the document and its resources are
//  about to be unloaded. 
// The document is still visible and the event is still cancelable at this point.

// This event enables a web page to trigger a confirmation dialog asking the user if they really
//  want to leave the page.If the user confirms, the browser navigates to the new page, otherwise
//  it cancels the navigation.
